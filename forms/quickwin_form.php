...
$supervisor_pid  = $data['s_p_id']          ?? '';
$teacher_pid     = $data['t_pid']           ?? '';
...
<body>
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <a href="javascript:history.back()" style="position: absolute; top: 15px; left: 15px; z-index: 1030;" class="btn btn-danger">
                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        ...
                        <form action="save_quickwin_data.php" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="observation_notes" class="form-label">หรือ อื่นๆ (ไม่บังคับกรอก)</label>
                                <textarea
                                    class="form-control"
                                    id="observation_notes"
                                    name="observation_notes"
                                    rows="5"
                                    placeholder="ถ้ามีหัวข้ออื่น ๆ เพิ่มเติม สามารถกรอกได้ที่นี่..."></textarea>
                            </div>
